...
payloadFields = {'LandingTargetPoint', 'LandingStartPosition', 'LandingProgress', ...
    'LandingDesiredSpeed', 'LandingComplete', 'LandingDistance', 'LandingStartTime'};
outputFields = {'LandingProgress', 'LandingDistance', 'LandingComplete', 'LandingTargetPoint'};
...
disp('testBirdLandingFields passed.');
